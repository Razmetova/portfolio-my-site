<div class="b-mainPicture">
    <h1 class="b-mainPicture__head b-mainPicture__head_bottom">
        <span class="b-mainPicture__head b-mainPicture__head_bold">the</span> brand</h1>
    <h3 class="b-mainPicture__slogan">company slogan goes here</h3>
</div>

<main class="b-mainTheBrand">
    ...
    <div class="b-handDesignetDesc">
        ...
        <p class="b-handDesignetDesc__text">
            Praesent feugiat malesuada tristique maecenas rhoncus diam eget quam vestibulim 
            consectetur, id condimentum leo porttitor. Cum sociis natoque penatibus eta magnis 
            disut parturient montes, nascetur ridiculus mus. Donec sem lorem laoreet tempor un 
    ...
    <div class="b-ethicalTradingDesc">
        ...
        <p class="b-ethicalTradingDesc__text">
            Nullam dapibus consectetur neque, faucibus porttitor purus iaculis sed. Aenean eras 
            dapibus augue, eget dignissim dui maecenas et rhoncus mim, vel semper arcu lorem
    ...
    <div class="b-ourValuesDesc">
        ...
        <p class="b-ourValuesDesc__text">
            Cras maximus venenatis malesuada. Nulla sagittis elit felis, ac facilisis quam 
            ornare aliquam. Etiam cursus odio vitae dui dignissim, sed tempus lacus tincidunt 
            et donec sapien velit, rhoncus eu nulla a, molestie tempus mi maecenas sagittis ornare.
    ...
    <div class="b-signatures b-signatures_top">
        ...
        <img src="images/signature-3.png" alt="signature-3" class="b-signatures__sign">
    </div>
</main>